...
function Home(props) {
  ...
  return (
    <section className="gasy-content home-wrapper">
      ...
      <Fireworks />
      <Image className="hanuman1" src={process.env.PUBLIC_URL + "/assets/download-removebg.png"} />
      <Image
        className="hanuman2"
        src={process.env.PUBLIC_URL +"/assets/download__1_-removebg-preview.png"}
      />
      <Image
        className="hanuman3"
        src={process.env.PUBLIC_URL +"/assets/hanuman_in_air-removebg-preview.png"}
      />
      <Image
        className="hanuman4"
        src={process.env.PUBLIC_URL +"/assets/cf098578-d074-4588-8e8a-438f71db1b38-removebg-preview.png"}
      />
      <Image
        className="ram"
        src={process.env.PUBLIC_URL +"/assets/Hindu_Temples.png"}
      />
      <Image
        className="jaishriram"
        src={process.env.PUBLIC_URL +"/assets/Jai_Shree_Ram_-_Salutation_to_Lord_Rama-removebg-preview.png"}
      />
    </section>
  );
}
